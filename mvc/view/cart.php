            ...
            <div class="row">
                <div class="col-lg-12">
                        ...
                        ?>
                                <tr>
                                    <td class="thumbnail-img">
                                        <a href="#">
									<img class="img-fluid" src="<?php echo $pro[7] ?>" alt="" />
								</a>
                                    </td>
                                    <td class="name-pr">
                                        <a href="#">
                                    ...
                                    <td class="price-pr">
                                        <p>DT <?php echo $pro[6] ?></p>
                                    </td>
                                    <!-- naaml update lil quantite fi cart -->
                                    <td class="quantity-box"><input type="number" size="4" value="<?php echo $l[3] ?>" min="0" step="1" class="c-input-text qty text"></td>
                                    <td class="total-pr">
                                        <p>DT <?php echo $l[5] ?></p>
                                    </td>
                                    <td class="remove-pr">
                                        <a href="deletepropannier.php?id=<?php echo $l[0] ?>">
                    ...
                    <div class="update-box">
                        <a href="updatepannier.php?id=<?php echo $l[0]?>">
                        <input value="Modify" type="button">
                        </a>
                    </div>
                </div>
                                    </td>
            ...
            <div class="row">
                ...
                <div class="col-lg-10 col-sm-12">
                    <div class="order-box">
                        ...
                        <div class="d-flex">
                            <h4>Sub Total</h4>
                            <div class="ml-auto font-weight-bold">DT <?php echo $totlal ?> </div>
                        </div>
                        <hr>
                        <div class="d-flex gr-total">
                            <h5>Grand Total</h5>
                            <div class="ml-auto h5"> DT <?php echo $totlal ?> </div>
                        </div>
                        <hr> </div>
                </div>
                <div class="col-8 d-flex shopping-box"><a href="checkout.php" class="ml-auto btn hvr-hover">Checkout</a> </div>
            </div>
