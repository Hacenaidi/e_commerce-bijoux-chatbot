...
<body>
                    ...
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="dropdown megamenu-fw">
                            ...
                            <ul class="dropdown-menu megamenu-content" role="menu">
                                <li>
                                    <!-- bech nrigl lien w bech na3mlilhom elkol copier coller fi paget lo5ra   -->
                                    <div class="row">
                                        <div class="col-menu col-md-3">
                                            ...
                                            <div class="content">
                                                <ul class="menu-col">
                                                    ...
                                                    <li><a href="shop.php?nom=Sweaters & Cardigans">Sweaters & Cardigans</a></li>
    ...
    <div class="categories-shop">
        <div class="container">
            <div class="row">
                <?php
                while($l = $produits->fetch()){
                ?>
                <div class="col-lg-4 col-md-4 ">
                    <div class="shop-cat-box">
                        <img  src="<?php echo $l[1]?>" alt="" width='500px' height='350px'/>
                        <a class="btn hvr-hover" href="shop.php?nom=<?php echo $l[0]?>"><?php echo $l[0]?></a>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-all text-center">
                        ...
                        <p>Find out more about Dolor Sit Amat</p>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row special-list">
                <div class="col-lg-3 col-md-6 special-grid best-seller">
                    <div class="products-single fix">
                        ...
                        <div class="why-text">
                            <h4>Find out more about Dolor Sit Amat</h4>
                            <h5> $7.79</h5>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-all text-center">
                        <h1>latest blog</h1>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. But he himself is on the lake.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="blog-box">
                        ...
                        <div class="blog-content">
                            <div class="title-blog">
                                <h3>They are not only in August but also finches</h3>
                                <p>No egestas from the urn, the door is free, the suspicion is there. Everyone sits on the lectern with dignified emotion. The harassment of the pharetra is a soft touch. Now, the end of the course is softened by the mollis. The present lacinia of the elite is there.</p>
                            </div>
    ...
    <!-- End Blog  -->
<!-- /dont tach this part its for the chatbot widget and its include in the index page only -->
    <!-- <?php
